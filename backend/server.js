...
const prompt = `A realistic version of the subject in the input drawing, preserving its unique shape and form. The subject moves in the ${environment}. Cinematic, photorealistic, vibrant lighting, smooth animation.`;
